...
<main role="main" class="container">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <input type="text" class="form-control" id="NoTelp" name="NoTelp" placeholder="Masukan no telepon" value="<?php if (isset($data_pelanggan->NoTelp)) echo $data_pelanggan->NoTelp; ?>" pattern="[0-9]*" disabled>
        </div>
    </div>
    <div class="form-group">
